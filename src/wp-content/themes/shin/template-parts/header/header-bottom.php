...
<div id="wide-nav" class="header-bottom wide-nav <?php header_inner_class('bottom'); ?>">
    <div class="flex-row container ">
            ...
            <div class="flex-col hide-for-medium main-menu-bottom flex-left">
            ...
            <div class="flex-col hide-for-medium main-menu-bottom flex-center">
            ...
            <div class="flex-col hide-for-medium main-menu-bottom flex-right flex-grow">
            ...
            <?php if(get_theme_mod('header_mobile_elements_bottom')) { ?>
              <div class="flex-col show-for-medium main-menu-bottom flex-grow">
